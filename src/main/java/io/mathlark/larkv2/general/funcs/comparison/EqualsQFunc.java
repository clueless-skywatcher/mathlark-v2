...
public class EqualsQFunc extends LarkFunction {

    public EqualsQFunc(SymbolScope scope, Map<String, DefinedFunction> funcs) {
        super(scope, funcs);
    ...
    public IExpression mainEval(IExpression[] exprs) {
        return ExpressionComparison.equalsExp(exprs[0], exprs[1]);
    }
