...
public class LarkInterpretParser extends Parser {
	...
	public LarkInterpretParser(TokenStream input) {
		super(input);
	...
	public static class EvaluatorContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(LarkInterpretParser.EOF, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).enterEvaluator(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).exitEvaluator(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LarkInterpretVisitor ) return ((LarkInterpretVisitor<? extends T>)visitor).visitEvaluator(this);
	...
	public static class ActualParamsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).enterActualParams(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).exitActualParams(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LarkInterpretVisitor ) return ((LarkInterpretVisitor<? extends T>)visitor).visitActualParams(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TermContext extends ParserRuleContext {
		...
		public TerminalNode IDENTIFIER() { return getToken(LarkInterpretParser.IDENTIFIER, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode INTEGER() { return getToken(LarkInterpretParser.INTEGER, 0); }
		public TerminalNode DECIMAL() { return getToken(LarkInterpretParser.DECIMAL, 0); }
		public TerminalNode STRING() { return getToken(LarkInterpretParser.STRING, 0); }
		public TerminalNode BOOLEAN() { return getToken(LarkInterpretParser.BOOLEAN, 0); }
		public TerminalNode CHARACTER() { return getToken(LarkInterpretParser.CHARACTER, 0); }
		public ActualParamsContext actualParams() {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).enterTerm(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).exitTerm(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LarkInterpretVisitor ) return ((LarkInterpretVisitor<? extends T>)visitor).visitTerm(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AssignContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).enterAssign(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).exitAssign(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LarkInterpretVisitor ) return ((LarkInterpretVisitor<? extends T>)visitor).visitAssign(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ReturnStmtContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).enterReturnStmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).exitReturnStmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LarkInterpretVisitor ) return ((LarkInterpretVisitor<? extends T>)visitor).visitReturnStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionAnonDefContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).enterFunctionAnonDef(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).exitFunctionAnonDef(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LarkInterpretVisitor ) return ((LarkInterpretVisitor<? extends T>)visitor).visitFunctionAnonDef(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class UnaryContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).enterUnary(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).exitUnary(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LarkInterpretVisitor ) return ((LarkInterpretVisitor<? extends T>)visitor).visitUnary(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExponentContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).enterExponent(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).exitExponent(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LarkInterpretVisitor ) return ((LarkInterpretVisitor<? extends T>)visitor).visitExponent(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MultiplyContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).enterMultiply(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).exitMultiply(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LarkInterpretVisitor ) return ((LarkInterpretVisitor<? extends T>)visitor).visitMultiply(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LarkInterpretListener ) ((LarkInterpretListener)listener).exitExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LarkInterpretVisitor ) return ((LarkInterpretVisitor<? extends T>)visitor).visitExpr(this);
			else return visitor.visitChildren(this);
		}
	}
